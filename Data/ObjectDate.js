...
// OBS: Date.now - retorna uma série de números em milessegundos, que nada mais é do que a data/hora atual!
const dataDateNow = new Date(Date.now())
console.log(Date.now());// Série de nums em ms - 1732887450674
console.log(dataDateNow.toString());
